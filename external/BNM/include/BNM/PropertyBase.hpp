...
/**
    ...
    This class provides fields and some basic functions to allow toget and set
   properties.
*/
struct PropertyBase {
  /**
  ...
  */
  ...
  /**
      ...
      @return Reference to current PropertyBase
  */
  inline PropertyBase &operator[](void *instance) {
  ...
  /**
      ...
      @return Reference to current PropertyBase
  */
  inline PropertyBase &operator[](IL2CPP::Il2CppObject *instance) {
  ...
  /**
      ...
      @return Reference to current PropertyBase
  */
  inline PropertyBase &operator[](UnityEngine::Object *instance) {
    SetInstance((IL2CPP::Il2CppObject *)instance);
    return *this;
  }
  ...
  */
  ...
  /**
      ...
      Returns string with full property name: ClassFullName.(property
     name){getter: exists/not exist, setter: exists/not exist} (static)/nothing

      @return Property's full name or "Dead property"
  */
  [[nodiscard]] inline std::string str() const {
    if (!_data)
      return BNM_OBFUSCATE(DBG_BNM_MSG_PropertyBase_str_nullptr);
    ...
    return Class(_data->parent).str() + BNM_OBFUSCATE(".(") + _data->name +
           ...
           (_hasGetter
                ? BNM_OBFUSCATE(DBG_BNM_MSG_PropertyBase_str_exists)
                : BNM_OBFUSCATE(DBG_BNM_MSG_PropertyBase_str_not_exists)) +
           ...
           BNM_OBFUSCATE("}") +
           (isStatic
                ? BNM_OBFUSCATE("(" DBG_BNM_MSG_PropertyBase_str_static ")")
                : BNM_OBFUSCATE(""));
  }
#endif
  ...
  */
  template <typename NewRet> inline Property<NewRet> &cast() const {
    return (Property<NewRet> &)*this;
  }
   ...
   * @param val New value
   */
  template <typename T> inline void SetValue(T val) {
