...
/**
    ...
    This class allows to find classes or get class from types, objects and work
   with it.
*/
struct Class {
  /**
  ...
  */
  inline Class(const BNM::IL2CPP::Il2CppClass *_class)
      : _data((BNM::IL2CPP::Il2CppClass *)_class) {};
  ...
  */
  ...
  /**
      ...
      Creates class using mono type (il2cpp vm's type), that passed as
     parameter.
  ...
  */
  [[nodiscard]] std::vector<BNM::Class>
  GetInterfaces(bool includeParent = true) const;
  ...
  */
  [[nodiscard]] std::vector<BNM::Class>
  GetInnerClasses(bool includeParent = true) const;
  ...
  */
  [[nodiscard]] std::span<BNM::IL2CPP::Il2CppClass *>
  GetInnerClassesSpan() const;
  ...
  */
  [[nodiscard]] std::vector<BNM::FieldBase>
  GetFields(bool includeParent = true) const;
  ...
  */
  [[nodiscard]] std::vector<BNM::MethodBase>
  GetMethods(bool includeParent = true) const;
  ...
  */
  [[nodiscard]] std::span<const BNM::IL2CPP::MethodInfo *>
  GetMethodsSpan() const;
  ...
  */
  [[nodiscard]] std::vector<BNM::PropertyBase>
  GetProperties(bool includeParent = true) const;
  ...
  */
  [[nodiscard]] std::vector<BNM::EventBase>
  GetEvents(bool includeParent = true) const;

  /**
      @brief Get method by name and parameters count.

      Tries to get method using its name and parameters count.
      If method isn't found in target class, the code will search method in
     parents.
  ...
  */
  [[nodiscard]] BNM::MethodBase GetMethod(const std::string_view &name,
  ...
  /**
     ...
     parents.
      ...
      @return MethodBase object
  */
  [[nodiscard]] BNM::MethodBase GetMethod(
  ...
  */
  ...
  /**
      ...
      If property isn't found in target class, the code will search property in
     parents.
  ...
  */
  [[nodiscard]] BNM::PropertyBase
  GetProperty(const std::string_view &name) const;
  ...
  */
  [[nodiscard]] BNM::PropertyBase
  GetProperty(const std::string_view &name,
              const BNM::CompileTimeClass &type) const;

  /**
      @brief Get inner class by name.

      Tries to get inner class using its name.
      If inner class isn't found in target class, the code will search inner
     class in parents.
  ...
  */
  ...
  /**
      ...
      If field isn't found in target class, the code will search field in
     parents.
  ...
  */
  ...
  /**
      ...
      If event isn't found in target class, the code will search event in
     parents.
  ...
  */
  [[nodiscard]] BNM::Class
  GetGeneric(const std::initializer_list<BNM::CompileTimeClass> &templateTypes)
      const; // Class <types from the list>
  ...
  */
  ...
  /**
      ...
      @return Il2CppClass
  */
  [[nodiscard]] inline BNM::IL2CPP::Il2CppClass *GetClass() const {
    TryInit();
    return _data;
  }
  ...
  */
  ...
  /**
      ...
      The same as `new Object()` in C#, but without calling the constructor
     (.ctor).
  ...
  */
  template <typename T>
  BNM::Structures::Mono::Array<T> *
  NewArray(IL2CPP::il2cpp_array_size_t size = 0) const {
  ...
  /**
      ...
      @return New list
  */
  template <typename T> Structures::Mono::List<T> *NewList() const;

  /**
      @brief Create list of this type.
      @warning It's not recommended to use for beginners!

      Creates new list of this types, but new list will use BNM code instead of
     il2cpp. This can be useful if you want to create list of struct that
     doesn't exist in target Unity app.

      @tparam T List element type
      @return New list
  */
  template <typename T> Structures::Mono::List<T> *NewListBNM() const {
    BNM_LOG_ERR_IF(!_data, DBG_BNM_MSG_Class_Dead_Error);
    if (!_data)
      return nullptr;
    TryInit();
  ...
  /**
      ...
      Box object that you pass into it, used to pass `int` and other system
     types as Il2CppObject. If you unsure, read C# documentation about object
     boxing.
  ...
  */
  ...
  /**
      ...
      The same as `new Object()` in C# with calling the constructor by number of
     parameters.
  ...
  */
  ...
  CreateNewObjectParameters(Parameters... parameters) const;

  /**
      @brief Create class instance.

      Creates instance of current class and calls constructor.
      The same as `new Object()` in C# with calling the constructor by parameter
     names.
  ...
  */
  template <typename... Parameters>
  BNM::IL2CPP::Il2CppObject *CreateNewObjectTypes(
  ...
  */
  ...
  /**
      ...
      Returns string with full class name: [Image
     name]::[Namespace]::[Name]->[Inner name]

      @return Class full name or "Dead class"
  */
  [[nodiscard]] inline std::string str() const {
    if (!_data)
      return BNM_OBFUSCATE(DBG_BNM_MSG_Class_str_nullptr);
    TryInit();
    std::string data{};
    if (_data->declaringType) {
      ...
      data += _data->namespaze + std::string(BNM_OBFUSCATE("]::[")) +
              _data->name + BNM_OBFUSCATE("]");
    }
...
private:
  ...
  static IL2CPP::Il2CppArray *ArrayNew(IL2CPP::Il2CppClass *,
                                       IL2CPP::il2cpp_array_size_t);
...
/**
    ...
    A structure for storing data at compile time and then searching for it
...
struct CompileTimeClass {
  ...
  inline CompileTimeClass(Defaults::Internal::ClassType *reference)
  ...
  inline void _SetBit() {
    _reference = (Defaults::Internal::ClassType *)(((uintptr_t)_reference) | 1);
  }
  inline void _RemoveBit() {
    _reference =
        (Defaults::Internal::ClassType *)(((uintptr_t)_reference) & ~1);
  }
  /// @endcond
  ...
  */
  ...
  struct _ClassInfo : _BaseInfo {
    _ClassInfo(const char *_namespace, const char *_name,
               const char *_imageName = nullptr)
        : _BaseInfo(_BaseType::Class), _namespace(_namespace), _name(_name),
  ...
  struct _ModifierInfo : _BaseInfo {
    _ModifierInfo(ModifierType _modifierType)
        : _BaseInfo(_BaseType::Modifier), _modifierType(_modifierType) {}
    ModifierType _modifierType{ModifierType::None};
  };
  struct _GenericInfo : _BaseInfo {
    _GenericInfo(const std::initializer_list<CompileTimeClass> &_types)
        : _BaseInfo(_BaseType::Generic), _types(_types) {}
...
struct CompileTimeClassBuilder {
  ...
  /**
      ...
      @param autoFree Should CompileTimeClass be freed after class was found or
     shouldn't (used mostly internally).
  */
  inline CompileTimeClassBuilder(const char *_namespace, const char *_name,
                                 const char *_imageName = nullptr,
                                 bool autoFree = true) {
    if (autoFree)
      _data._SetBit();
    auto info = (CompileTimeClass::_ClassInfo *)BNM_malloc(
        sizeof(CompileTimeClass::_ClassInfo));
  ...
  */
  inline CompileTimeClassBuilder &Class(const char *_name) {
    auto info = (CompileTimeClass::_InnerInfo *)BNM_malloc(
        sizeof(CompileTimeClass::_InnerInfo));
  ...
  /**
      ...
      @return Reference to current builder
  */
  inline CompileTimeClassBuilder &
  Modifier(CompileTimeClass::ModifierType type) {
    auto modifier = (CompileTimeClass::_ModifierInfo *)BNM_malloc(
        sizeof(CompileTimeClass::_ModifierInfo));
  ...
  */
  inline CompileTimeClassBuilder &
  Generic(const std::initializer_list<CompileTimeClass> &templateTypes) {
    auto generic = (CompileTimeClass::_GenericInfo *)BNM_malloc(
        sizeof(CompileTimeClass::_GenericInfo));
...
template <typename T> Structures::Mono::List<T> *Class::NewList() const {
  BNM_LOG_ERR_IF(!_data, DBG_BNM_MSG_Class_Dead_Error);
  if (!_data)
    return nullptr;
  TryInit();
  auto lst = (BNM::Structures::Mono::List<T> *)GetListClass()
                 .GetGeneric({GetCompileTimeClass()})
...
bool IsA(T object, IL2CPP::Il2CppClass *_class) {
  return IsA<BNM::IL2CPP::Il2CppObject *>((IL2CPP::Il2CppObject *)object,
                                          _class);
}
...
*/
template <>
bool IsA<IL2CPP::Il2CppObject *>(IL2CPP::Il2CppObject *object,
...
bool IsA(T object, Class _class) {
  return IsA(object, _class.GetClass());
}
...
bool IsA(T object, IL2CPP::Il2CppObject *_object) {
  if (!_object)
    return false;
  return IsA(object, _object->klass);
}
