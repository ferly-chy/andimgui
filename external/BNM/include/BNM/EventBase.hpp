...
/**
    ...
    This class provides fields and some basic functions to allow call, add and
   remove methods in event.
*/
struct EventBase {
  /**
  ...
  */
  ...
  /**
      ...
      @return Reference to current EventBase
  */
  inline EventBase &operator[](void *instance) {
  ...
  /**
      ...
      @return Reference to current EventBase
  */
  inline EventBase &operator[](IL2CPP::Il2CppObject *instance) {
  ...
  /**
      ...
      @return Reference to current EventBase
  */
  inline EventBase &operator[](UnityEngine::Object *instance) {
    SetInstance((IL2CPP::Il2CppObject *)instance);
    return *this;
  }
  ...
  */
  ...
  /**
      ...
      Returns string with full event name: ClassFullName.(event name){add
     method: exists/not exist, remove method: exists/not exist, raise method:
     exists/not exist} (static)/nothing

      @return Event's full name or "Dead event".
  */
  [[nodiscard]] inline std::string str() const {
    if (!_data)
      return BNM_OBFUSCATE(DBG_BNM_MSG_EventBase_str_nullptr);
    auto isStatic = _hasAdd      ? _add._isStatic
                    : _hasRemove ? _remove._isStatic
                                 : _raise._isStatic;
...
#endif
           BNM_OBFUSCATE("){" DBG_BNM_MSG_EventBase_str_add ": ") +
           (_hasAdd ? BNM_OBFUSCATE(DBG_BNM_MSG_EventBase_str_exists)
                    : BNM_OBFUSCATE(DBG_BNM_MSG_EventBase_str_not_exists)) +
           BNM_OBFUSCATE(", " DBG_BNM_MSG_EventBase_str_remove ": ") +
           (_hasRemove ? BNM_OBFUSCATE(DBG_BNM_MSG_EventBase_str_exists)
                       : BNM_OBFUSCATE(DBG_BNM_MSG_EventBase_str_not_exists)) +
           BNM_OBFUSCATE(", " DBG_BNM_MSG_EventBase_str_raise ": ") +
           (_hasRaise ? BNM_OBFUSCATE(DBG_BNM_MSG_EventBase_str_exists)
                      : BNM_OBFUSCATE(DBG_BNM_MSG_EventBase_str_not_exists)) +
           BNM_OBFUSCATE("}") +
           (isStatic ? BNM_OBFUSCATE("(" DBG_BNM_MSG_EventBase_str_static ")")
                     : BNM_OBFUSCATE(""));
  }
#endif
  ...
  */
  ...
  inline Event<NewRet, NewParameters...> &cast() const {
    return (Event<NewRet, NewParameters...> &)*this;
  }
