...
typedef const struct Il2CppCustomAttributeTypeRange
    *Il2CppMetadataCustomAttributeHandle;
typedef const struct Il2CppTypeDefinition *Il2CppMetadataTypeHandle;
typedef const struct Il2CppMethodDefinition
    *Il2CppMetadataMethodDefinitionHandle;
typedef const struct Il2CppGenericContainer
    *Il2CppMetadataGenericContainerHandle;
typedef const struct Il2CppGenericParameter
