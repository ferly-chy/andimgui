...
struct Vector3 {
  ...
  inline std::string str() {
    return std::to_string(x) + std::string(BNM_OBFUSCATE(", ")) +
           std::to_string(y) + std::string(BNM_OBFUSCATE(", ")) +
           std::to_string(z);
  }
  ...
  inline friend Vector3 operator*(Vector3 v, int s) {
    return {v.x * s, v.y * s, v.z * s};
  }
  inline friend Vector3 operator*(float s, Vector3 v) {
    return {v.x * s, v.y * s, v.z * s};
  }
  inline friend Vector3 operator*(int s, Vector3 v) {
    return {v.x * s, v.y * s, v.z * s};
  }
  inline friend Vector3 operator*(Vector3 lhs, Vector3 rhs) {
    return {lhs.x * rhs.x, lhs.y * rhs.y, lhs.z * rhs.z};
