...
struct Color {
  ...
  inline constexpr Color(float r, float g, float b)
      : r(r), g(g), b(b), a(1.f) {}
  ...
  [[nodiscard]] inline std::string str() const {
    return std::string(BNM_OBFUSCATE("r: ")) + std::to_string(r) +
           std::string(BNM_OBFUSCATE(", g: ")) + std::to_string(g) +
           std::string(BNM_OBFUSCATE(", b: ")) + std::to_string(b) +
           std::string(BNM_OBFUSCATE(", a: ")) + std::to_string(a);
  };
  ...
  inline static Color HSVToRGB(float H, float S, float V, bool hdr = true) {
    ...
    return {std::clamp(retVal.r, 0.0f, 1.0f), std::clamp(retVal.g, 0.0f, 1.0f),
            std::clamp(retVal.b, 0.0f, 1.0f)};
  }
  ...
  static const Color black, red, green, blue, white, orange, yellow, cyan,
      magenta;
};
