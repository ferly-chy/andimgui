...
*/
template <typename T> struct Field : public FieldBase {
  /**
  ...
  */
  inline T *GetPointer() const {
    ...
    BNM_LOG_ERR_IF(ptr == nullptr, DBG_BNM_MSG_Field_GetPointer_Error,
                   _data ? str().c_str() : DBG_BNM_MSG_Field_GetPointer_Dead);
    return (T *)ptr;
  }
  ...
  */
  inline Field<T> &operator=(T value) {
    Set(std::move(value));
    return *this;
  }
  ...
  */
  inline Field<T> &operator[](void *instance) {
  ...
  /**
      ...
      @return Reference to current Field
  */
  inline Field<T> &operator[](IL2CPP::Il2CppObject *instance) {
  ...
  /**
      ...
      @return Reference to current Field
  */
  inline Field<T> &operator[](UnityEngine::Object *instance) {
    SetInstance((IL2CPP::Il2CppObject *)instance);
    return *this;
  }
