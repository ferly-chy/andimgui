...
/**
    ...
    This class provides fields and some basic functions to allow to get and set
   fields.
*/
struct FieldBase {
  /**
  ...
  */
  [[nodiscard]] inline BNM_PTR GetOffset() const {
    return _data ? (BNM_PTR)_data->offset -
                       (_isInStruct && !_isStatic && !_isThreadStatic
                            ? sizeof(IL2CPP::Il2CppObject)
                            : 0x0)
                 : 0;
  }
  ...
  /**
      ...
      It's useful for structs or if you want to save pointer to be able to use
     it directly without BNM's overhead.

      @return Field pointer if field is valid and instance is set for non-static
  ...
  */
  ...
  /**
      ...
      @return Reference to current FieldBase
  */
  inline FieldBase &operator[](void *instance) {
  ...
  /**
      ...
      @return Reference to current FieldBase
  */
  inline FieldBase &operator[](IL2CPP::Il2CppObject *instance) {
  ...
  /**
      ...
      @return Reference to current FieldBase
  */
  inline FieldBase &operator[](UnityEngine::Object *instance) {
    SetInstance((IL2CPP::Il2CppObject *)instance);
    return *this;
  }
  ...
  */
  template <typename NewType> inline Field<NewType> &cast() const {
    return (Field<NewType> &)*this;
  }
   ...
   * @param val New value
   */
  template <typename T> inline void SetValue(T val) const {
    ((Field<T> *)this)->Set(val);
  }

  BNM::IL2CPP::FieldInfo *_data{};
  BNM::IL2CPP::Il2CppObject *_instance{};
  uint8_t _isStatic : 1 = false, _isThreadStatic : 1 = false,
                      _isInStruct : 1 = false, _isConst : 1 = false;
};
