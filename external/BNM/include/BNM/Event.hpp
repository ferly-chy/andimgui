...
struct Event : EventBase {
  ...
  */
  inline Event<Ret, Parameters...> &operator[](void *instance) {
  ...
  /**
      ...
      @return Reference to current Event
  */
  inline Event<Ret, Parameters...> &operator[](IL2CPP::Il2CppObject *instance) {
  ...
  /**
      ...
      @return Reference to current Event
  */
  inline Event<Ret, Parameters...> &operator[](UnityEngine::Object *instance) {
    SetInstance((IL2CPP::Il2CppObject *)instance);
    return *this;
  }
  ...
  */
  inline void Add(Delegate<Ret> *delegate) {
    if (_hasAdd)
      return _add.cast<void>()(delegate);
  ...
  /**
      ...
      @param delegate Delegate to add
  */
  inline Event<Ret, Parameters...> &operator+=(Delegate<Ret> *delegate) {
    Add(delegate);
    return *this;
  }
  ...
  */
  inline void Remove(Delegate<Ret> *delegate) {
    if (_hasRemove)
      return _remove.cast<void>()(delegate);
  ...
  /**
      ...
      @param delegate Delegate to remove
  */
  inline Event<Ret, Parameters...> &operator-=(Delegate<Ret> *v) {
    Remove(v);
    return *this;
  }
  ...
  */
  inline Ret Raise(Parameters... parameters) const {
    if (_hasRaise)
      return _raise.cast<Ret>()(parameters...);
