...
struct Image {
  ...
  */
  inline Image(const BNM::IL2CPP::Il2CppImage *image)
      : _data((BNM::IL2CPP::Il2CppImage *)image) {}
  ...
  */
  ...
  GetClasses(bool includeInner = false) const;

  /**
       @brief Get classes count.
       @return Classes count if image is valid, otherwise zero.
   */
  [[nodiscard]] inline uint32_t GetClassesCount() const {
    return _data ? _data->typeCount : 0;
  }
  ...
  /**
      ...
      @return Il2CppImage
  */
  [[nodiscard]] inline BNM::IL2CPP::Il2CppImage *GetInfo() const {
    return _data;
  }
