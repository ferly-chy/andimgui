...
struct CustomMethod {
  ...
  std::vector<CompileTimeClass>
      _parameterTypes{}; // Will be freed after BNM initializes this method
  ...
  struct OriginInvokeGetter<RetT (T::*)(ParametersT...)> {
    IL2CPP::MethodInfo *_origin{};
    void *_originalAddress{};
    explicit OriginInvokeGetter(const CustomMethod &method)
        : _origin(method._origin), _originalAddress(method._originalAddress) {}
    inline RetT Invoke(T *instance, ParametersT... parameters) {
      if (!_origin)
        return PRIVATE_INTERNAL::ReturnEmpty<RetT>();
      return ((RetT (*)(T *, ParametersT..., IL2CPP::MethodInfo *))
                  _originalAddress)(instance, parameters..., _origin);
    }
  };
  ...
  struct OriginInvokeGetter<RetT (*)(ParametersT...)> {
    ...
    inline RetT Invoke(ParametersT... parameters) {
      if (!_origin)
        return PRIVATE_INTERNAL::ReturnEmpty<RetT>();
#if UNITY_VER > 174
      return ((RetT (*)(ParametersT..., IL2CPP::MethodInfo *))_originalAddress)(
          parameters..., _origin);
#else
      return ((RetT (*)(void *, ParametersT..., IL2CPP::MethodInfo *))
                  _originalAddress)(nullptr, parameters..., _origin);
#endif
    }
  };
};
...
template <typename T> inline void *PackReturnArg(T arg, void *returnValue) {
  *(T *)returnValue = arg;
  return nullptr;
}
#else
...
struct GetMethodInvoker<false, RetT (T::*)(ParametersT...)> {
  ...
  inline static void *InvokeMethod(RetT (*func)(T *, ParametersT...),
                                   T *instance, void **args, void *data,
                                   std::index_sequence<As...>) {
    if constexpr (std::is_same_v<RetT, void>) {
      func(instance, _InvokerHelper::UnpackArg<ParametersT>(args[As])...);
      return nullptr;
    } else
      return _InvokerHelper::PackReturnArg(
          func(instance, _InvokerHelper::UnpackArg<ParametersT>(args[As])...),
          ARG_4_PACK);
  }
#if UNITY_VER < 171
...
#else
  static void *Invoke(IL2CPP::Il2CppMethodPointer ptr,
                      [[maybe_unused]] IL2CPP::MethodInfo *method, void *obj,
                      void **args, void *returnValue) {
#endif
...
#endif
  template <std::size_t... As>
  inline static void *InvokeMethod(FuncType func, void **args, void *data,
                                   std::index_sequence<As...>) {
    if constexpr (std::is_same_v<RetT, void>) {
      func(Args);
      return nullptr;
    } else
      return _InvokerHelper::PackReturnArg(func(Args), ARG_4_PACK);
  }
#undef Args
#if UNITY_VER < 171
...
#else
  static void *Invoke(IL2CPP::Il2CppMethodPointer ptr,
                      [[maybe_unused]] IL2CPP::MethodInfo *method, void *,
                      void **args, void *returnValue) {
#endif
...
/**
    ...
    Use this macro to describe info about your C++ class to add it as valid
   class to il2cpp.<br> BNM will automatically convert all information to il2cpp
   valid format.

    This macro adds static field `BNMCustomClass` to target class.
    Using it you can access:
    @code
    BNM::IL2CPP::Il2CppClass *myClass // Generated/modified il2cpp class object
   of current custom class BNM::MonoType *type // Mono type of current custom
   class, to be used in, for example `AddComponent`
    // And there are some other internal data that are used by BNM to
   create/modify il2cpp class.
    @endcode

    @param _class_ Class itself
    @param _targetType_ BNM::CompileTimeClass or how class will be presented in
   il2cpp
    @param _baseType_ BNM::CompileTimeClass of base class type
    @param _owner_ BNM::CompileTimeClass of owner class type (to make this class
   nested)
...
#define BNM_CustomClass(_class_, _targetType_, _baseType_, _owner_, ...)       \
  struct _BNMCustomClass : BNM::MANAGEMENT_STRUCTURES::CustomClass {           \
    inline _BNMCustomClass() : BNM::MANAGEMENT_STRUCTURES::CustomClass() {     \
      static_assert(                                                           \
          sizeof(_class_) >= sizeof(BNM::IL2CPP::Il2CppObject),                \
          "Class " #_class_                                                    \
          " should be inherit at least from BNM::IL2CPP::Il2CppObject!");      \
  ...
  inline static _BNMCustomClass BNMCustomClass                                 \
...
/**
    ...
    This macro adds static field `BNMCustomField_(_field_ param)` to target
   class. Using it you can access:
    @code
    BNM_PTR offset // Offset of current field in current class (useful for
   modifying class) BNM::IL2CPP::FieldInfo *myInfo // Generated il2cpp object of
   current field
    // And there are some other internal data that are used by BNM to create/add
   il2cpp field.
    @endcode

    @param _field_ Field itself
    @param _type_ BNM::CompileTimeClass of field type that will be presented in
   il2cpp
...
#define BNM_CustomField(_field_, _type_, _name_)                               \
  struct _BNMCustomField_##_field_ : BNM::MANAGEMENT_STRUCTURES::CustomField { \
    inline _BNMCustomField_##_field_()                                         \
        : BNM::MANAGEMENT_STRUCTURES::CustomField() {                          \
  ...
  inline static _BNMCustomField_##_field_ BNMCustomField_##_field_             \
...
/**
    ...
    This macro adds static field `BNMCustomMethod_(_method_ param)` to target
   class. Using it you can access:
    @code
    BNM::IL2CPP::MethodInfo *myInfo // Generated il2cpp object of current method
    // And there are some other internal data that are used by BNM to
   create/add/hook il2cpp method.
    @endcode
...
#define BNM_CustomMethod(_method_, _isStatic_, _type_, _name_, ...)            \
  struct _BNMCustomMethod_##_method_                                           \
      : BNM::MANAGEMENT_STRUCTURES::CustomMethod {                             \
    inline _BNMCustomMethod_##_method_()                                       \
        : BNM::MANAGEMENT_STRUCTURES::CustomMethod() {                         \
      constexpr auto p = &_BNMCustomClassType::_method_;                       \
      _address = *(void **)&p;                                                 \
      _invoker = (void *)&BNM::MANAGEMENT_STRUCTURES::GetMethodInvoker<        \
          _isStatic_, decltype(&_BNMCustomClassType::_method_)>::Invoke;       \
      _name = BNM_OBFUSCATE_TMP(_name_);                                       \
      _returnType = _type_;                                                    \
  ...
  inline static _BNMCustomMethod_##_method_ BNMCustomMethod_##_method_         \
      __attribute__((init_priority(102))) {}
...
/**
    ...
    If this macro is applied to method, BNM will prefer to use invoke hook for
   it.
    @param _method_ Target method
*/
#define BNM_CustomMethodMarkAsInvokeHook(_method_)                             \
  inline static struct _BNMCustomMethodMarkAs_##_method_ {                     \
    _BNMCustomMethodMarkAs_##_method_() {                                      \
      BNMCustomMethod_##_method_._isInvokeHook = true;                         \
    }                                                                          \
  } _BNMCustomMethodMarkAs_##_method_ __attribute__((init_priority(103))) {    \
  }
...
/**
    ...
    If this macro is applied to method, BNM will prefer to use basic hook for
   it.
    @param _method_ Target method
*/
#define BNM_CustomMethodMarkAsBasicHook(_method_)                              \
  inline static struct _BNMCustomMethodMarkAs_##_method_ {                     \
    _BNMCustomMethodMarkAs_##_method_() {                                      \
      BNMCustomMethod_##_method_._isBasicHook = true;                          \
    }                                                                          \
  } _BNMCustomMethodMarkAs_##_method_ __attribute__((init_priority(103))) {    \
  }
...
/**
    ...
    If this macro is applied to method, BNM will skip type matching for method
   overriding/hooking and instead it will use parameters count.
    @param _method_ Target method
*/
#define BNM_CustomMethodSkipTypeMatch(_method_)                                \
  inline static struct _BNMCustomMethodSkipTypeMatch_##_method_ {              \
    _BNMCustomMethodSkipTypeMatch_##_method_() {                               \
      BNMCustomMethod_##_method_._skipTypeMatch = true;                        \
    }                                                                          \
  } _BNMCustomMethodSkipTypeMatch_##_method_                                   \
...
/**
    ...
    If this macro is applied to the new method, BNM copies attributes from the
   method of the target class. Attributes are stored in methods as tokens, that
   refers to the metadata. So the easiest way is to reuse them. If this macro is
   applied to the existing method, nothing changes.
    @param _method_ Target method
    @param _copy_name_ Method to copy
*/
#define BNM_CustomMethodCopyAttributes(_method_, _copy_name_)                  \
  inline static struct _BNMCustomMethodCopyAttributes_##_method_ {             \
    _BNMCustomMethodCopyAttributes_##_method_() {                              \
      BNMCustomMethod_##_method_._copyTarget = BNM_OBFUSCATE_TMP(_copy_name_); \
    }                                                                          \
  } __BNMCustomMethodCopyAttributes_##_method_                                 \
      __attribute__((init_priority(103))) {                                    \
  }
...
/**
    ...
    This macro can be used to call overridden (base) method or origin (old code)
   of hooked method.
    @param _method_ Target method
    @param ... Method call arguments (for non-static method first argument
   should be `this`)
*/
#define BNM_CallCustomMethodOrigin(_method_, ...)                              \
  BNM::MANAGEMENT_STRUCTURES::CustomMethod::OriginInvokeGetter<                \
      decltype(&_BNMCustomClassType::_method_)>(BNMCustomMethod_##_method_)    \
      .Invoke(__VA_ARGS__)
/** @} */
#endif