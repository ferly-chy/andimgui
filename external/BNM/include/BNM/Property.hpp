...
*/
template <typename T = bool> struct Property : public PropertyBase {
  /**
  ...
  */
  inline Property<T> &operator[](void *instance) {
  ...
  /**
      ...
      @return Reference to current Property
  */
  inline Property<T> &operator[](IL2CPP::Il2CppObject *instance) {
  ...
  /**
      ...
      @return Reference to current Property
  */
  inline Property<T> &operator[](UnityEngine::Object *instance) {
    SetInstance((IL2CPP::Il2CppObject *)instance);
    return *this;
  }
  ...
  */
  inline void Set(T value) {
    if (_hasSetter)
      return _setter.cast<void>()(value);
  ...
  */
  inline Property<T> &operator=(T value) {
    Set(std::move(value));
    return *this;
  }
