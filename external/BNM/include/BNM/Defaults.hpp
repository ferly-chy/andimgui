...
/**
    ...
    It contains: Vector2, Vector3, Vector4, Color, Color32, Ray, RaycastHit,
   RaycastHit2D, Quaternion, Matrix3x3, Matrix4x4.
*/
...
// NOLINTBEGIN
/**
    @brief Namespace that helps to get references to primitives and common used
   C# and Unity types.
*/
...
extern ClassType Void, Boolean, Byte, SByte, Int16, UInt16, Int32, UInt32,
    IntPtr, UIntPtr, Int64, UInt64, Single, Double, Decimal, String, Object;
extern ClassType Vector2, Vector3, Vector4, Color, Color32, Ray, Quaternion,
...
struct DefaultTypeRef {
  ...
  constexpr inline operator Internal::ClassType() const {
...
/**
    ...
    BNM::IL2CPP::Il2CppString * (or) BNM::Structures::Mono::String *, string,
   System.String BNM::Structures::Unity::Vector2, Vector2, UnityEngine.Vector2
...
*/
template <typename T> constexpr DefaultTypeRef Get() {
  ...
  else if constexpr (std::is_same_v<T, BNM::IL2CPP::Il2CppString *> ||
                     std::is_same_v<T, Structures::Mono::String *>)
...
/**
    ...
    Method is based on BNM::Defaults::Get so only types supported by it will be
   boxed. Others will result null.

    @return Boxed value if type is supported, otherwise null.
*/
template <typename T> inline IL2CPP::Il2CppObject *Box(T value) {
