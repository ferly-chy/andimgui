...
void *__Internal_Array::ArrayFromClass(IL2CPP::Il2CppClass *cls,
...
String *String::Empty() {
  return Internal::vmData.String$$Empty ? *Internal::vmData.String$$Empty
                                        : nullptr;
}
...
void *PRIVATE_MonoListData::CompareExchange4List(void *syncRoot) {
  if (Internal::vmData.Interlocked$$CompareExchange.IsValid())
    Internal::vmData.Interlocked$$CompareExchange(
        (void **)&syncRoot, (void *)Internal::vmData.Object.CreateNewInstance(),
        (void *)nullptr);
  return syncRoot;
}
